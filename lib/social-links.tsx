...
const DiscordIcon = ({ className = "h-4 w-4" }: { className?: string }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 71 55" aria-hidden="true">
...
// External link icon (used for outbound links)
...
// All social links - single source of truth
