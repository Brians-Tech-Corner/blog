...
const socialLinks = [
  ...
  {
    name: "Instagram",
    href: "https://instagram.com/brianstechcorner",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
export function SiteFooter() {
  return (
    <footer className="border-t border-zinc-100 py-10">
      <div className="mx-auto w-full max-w-5xl px-4 text-sm text-zinc-600">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex-1">
            ...
            <p className="mt-3 max-w-3xl text-xs text-zinc-500">
              This site documents personal projects and experiments. All content is
              shared for learning and exploration purposes.
            </p>
          </div>
