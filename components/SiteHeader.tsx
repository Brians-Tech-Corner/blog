...
const socialLinks = [
  {
    ...
    icon: (
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 71 55" aria-hidden="true">
...
export function SiteHeader() {
  return (
    <header className="border-b border-zinc-100 dark:border-zinc-800">
      ...
      <div className="relative h-48 sm:h-64 md:h-80 lg:h-[28rem] w-full overflow-hidden border-b border-zinc-200 dark:border-zinc-800">
        <Image
          src="/brand/X-Banner-Blue.jpg"
