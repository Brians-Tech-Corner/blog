    ...
    <main className="mx-auto max-w-5xl px-4 py-14">
      ...
      <section className="mb-10">
        ...
        <p className="mt-4 max-w-2xl text-lg text-zinc-700">
          A collection of notes, experiments, and walkthroughs from building things at home —
          covering homelabs, automation, infrastructure, and backend projects.
        </p>
      ...
      {featured && (
        <section className="mb-12">
          ...
          >
            <div className="text-sm text-zinc-500">{featured.date}</div>
