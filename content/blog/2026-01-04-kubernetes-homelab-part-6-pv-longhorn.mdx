...
**Best Practice:**
Always migrate replicas and update volume settings when changing disk locations or resizing your cluster. This prevents scheduling failures and ensures Longhorn uses your available storage efficiently.
## What’s Next
