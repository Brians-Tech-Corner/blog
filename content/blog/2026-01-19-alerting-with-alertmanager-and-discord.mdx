...
Your discord message might look something like this depending on the alert you setup:

<ClickableImage src="/post-images/k8s-monitoring-series/discord-alert.jpg" alt="Discord alert notification example" caption="Example Discord alert notification from Alertmanager" />
...
This post is Part 2 of my **Homelab Observability** series:
