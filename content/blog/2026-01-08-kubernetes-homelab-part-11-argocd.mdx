...
tags: ["homelab", "proxmox", "kubernetes", "k8s", "argocd", "gitops", "automation", "cicd"]
...
<Callout type="info">
**Prerequisites**: This part assumes you've completed Parts 1-9 (K8s cluster with Traefik and Gateway API). Part 10 (HTTPS with cert-manager) is optional - we'll cover both HTTP and HTTPS configurations for the ArgoCD UI.
</Callout>
...
- **Cloudflare**: Create A record `argocd.yourdomain.com` → `192.168.30.200`
