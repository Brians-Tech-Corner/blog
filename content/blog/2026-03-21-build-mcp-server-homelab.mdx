...
**Don't expose secrets in tool output.** If you have tools that touch Kubernetes Secrets or config maps with credentials, be thoughtful about what you return. Claude might include secret values in its response.
...
- **Slack notifications** — Ask Claude "alert me in #alerts if any pod crashes" and have it actually wire up a watcher
