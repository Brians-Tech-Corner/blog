...
Before installing Proxmox, I added a second SSD to the mini PC for additional storage capacity and to use ZFS1 for redundancy. While not strictly required, this will make hardware failures easier to recover from and such.
...
1. **Remove the top cover**
   ...
   ![Mini PC](/post-images/homelab-k8s-series/post-2/mini-pc.jpg)
   ![Mini PC Top Cover Removed](/post-images/homelab-k8s-series/post-2/top-cover-off.jpg)
...
2. **Unscrew the fan assembly**
   ...
   ![Mini PC Fan Assembly](/post-images/homelab-k8s-series/post-2/fan-connector.jpg)
...
3. **Remove the fan**
   ...
   ![Mini PC Opened](/post-images/homelab-k8s-series/post-2/mini-pc-opened.jpg)
...
1. **Locate the M.2 slot**
   ...
   ![Mini PC SSD Slot](/post-images/homelab-k8s-series/post-2/ssd-slot.jpg)

2. **Insert the M.2 SSD**
   - Hold the SSD at a 30-45 degree angle
   - **Carefully align the notch** - the slot and drive have a specific orientation
   - Ensure the gold contacts line up with the M.2 connector
   ...
   ![SSD Drive](/post-images/homelab-k8s-series/post-2/ssd-image.jpg)

   ![SSD Installed](/post-images/homelab-k8s-series/post-2/ssd-installed.jpg)
...
In case it isn't clear on the first screen you come to, it will default to installing on just 1 drive, this is where you change the target to ZFS1 ane ensure both drives are showing up and selected.
